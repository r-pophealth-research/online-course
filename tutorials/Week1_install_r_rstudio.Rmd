...
![R programming language logo](images/r_logo.png)
...
![Homepage for RStudio with no project open](images/rstudio_no_project.png)
...
![RStudio console with basic math problems giving correct results like 2+2=4](images/rstudio_console.png)
...
![RStudio environment tab saying "Environment is empty"](images/rstudio_environment.png)
...
![RStudio files pane listing several folders with project names](images/rstudio_files.png)
...
![math problems written in the editor pane of RStudio](images/rstudio_editor.png)
