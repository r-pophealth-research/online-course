...
Welcome to Week 8 and 9! In this tutorial, we'll revisit data visualizations and learn how to use the `ggplot2` package to create publication-ready figures. This tutorial is on the longer side—take your time working through it section by section.
...
In this tutorial, we will be using maternal mortality data from the World Health Organization that has been merged with population data from the World Bank. The data file is available in the [course GitHub repo](https://github.com/r-pophealth-research/online-course/tree/main/data).
