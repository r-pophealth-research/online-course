...
Welcome to Week 8 and 9! Over the next two weeks, we'll revisit data visualizations and learn how to use the `ggplot2` package to create publication-ready figures. This tutorial is on the longer side, but you'll have two weeks to complete it. **Please complete up to (and including) the `Plotting bivariate distributions` section before Week 8's lecture and the whole tutorial before Week 9's lecture**.
