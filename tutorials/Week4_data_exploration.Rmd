...
Course datasets are stored in the [online-course `data` folder on GitHub](https://github.com/r-pophealth-research/online-course/tree/main/data). To load a CSV, pass its URL to `read_csv()`:
...
# [Optional] Groups: group_by() and summarize()
