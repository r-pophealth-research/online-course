...
In this chapter, we will be using maternal mortality data from the World Health Organization that has been merged with population data from the World Bank. Run the cell below to load the data as `maternal_mortality` and view the first few columns.
