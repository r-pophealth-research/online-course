...
Create a variable called `temp_f` that is equal to the current temperature in fahrenheit.
...
Now create a variable `temp_c` that converts the value of `temp_f` to celcius. Recall that °C = (°F - 32) ÷ (9/5)
